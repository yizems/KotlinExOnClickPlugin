...
public class MyDialog extends JDialog {
    ...
    public MyDialog(List<Element> data, CallBack callBack) {
        this();
        this.data = data;
...
//        }
    ...
    private void onOK() {
        ...
        List<Element> selectedValuesList = jList.getSelectedValuesList();
        dispose();
